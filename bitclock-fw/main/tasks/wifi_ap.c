...
static const char *SETUP_PAGE_TEMPLATE =
    ...
    "<title>Bitclock Wi-Fi Setup</title>"
    "<style>"
...
static const char *SUCCESS_PAGE =
    ...
    "<p>Bitclock is restarting and will connect to your network.</p>"
...
static esp_err_t get_handler(httpd_req_t *req) {
  ...
  const char *subtitle = (bool)req->user_ctx
                             ? "Could not connect to saved network."
                             : "Connect your Bitclock to Wi-Fi.";
